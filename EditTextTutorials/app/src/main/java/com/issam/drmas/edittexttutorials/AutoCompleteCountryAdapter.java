...
public class AutoCompleteCountryAdapter extends ArrayAdapter<CountryItem> {
    ...
    public AutoCompleteCountryAdapter(@NonNull Context context, @NonNull List<CountryItem> countrList) {
        super(context, 0, countrList);
        countryListFull = new ArrayList<>(countrList);
    }
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        if (convertView == null){
            convertView = LayoutInflater.from(getContext()).inflate(
                    R.layout.countrautocomplete_row, parent, false);
        }
