package com.issam.drmas.countdowntimer;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void setTime(long millisSeconds){
        mStartTimeInMillis = millisSeconds;
        resetTimer();
        closeKeyboard();
    }
    ...
    protected void onStart() {
        ...
        mTimerRunning = prefs.getBoolean("timeRunning", false);
