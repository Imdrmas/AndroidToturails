...
public class TechnologyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdView = (AdView) findViewById(R.id.adViewTechnology);
    ...
    public void toggleSuondTechnology(View view){

        Button toggleSuondArt = (Button) findViewById(R.id.toggleSuondTechnology);
