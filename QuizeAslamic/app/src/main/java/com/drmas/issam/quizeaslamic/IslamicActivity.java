...
public class IslamicActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdView = (AdView) findViewById(R.id.adViewIslamic);
    ...
    public void toggleSuondIslamic(View view){

        Button toggleSuondArt = (Button) findViewById(R.id.toggleSuondIslamic);
