...
public class PoliticActivity extends AppCompatActivity {
    ...
    private Button textCounterDownPolitic;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PoliticToolbar = findViewById( R.id.Politic_Toolbar);
        ...
        mAdView = (AdView) findViewById(R.id.adViewPolitic);
    ...
    private void ShowPopup() {
        ...
        mScoreView.setText( getString( R.string.score )+" "+ mScore+ "/" +politicQuestions.getLength()+ " ");
    ...
    public void toggleSuondPolitic(View view){

        Button toggleSuondArt = (Button) findViewById(R.id.toggleSuondPolitic);
    ...
    protected void onStart() {
        ...
        TextView titleTextDialog = (TextView) layout.findViewById( R.id.titleTextDialog );
        titleTextDialog.setText(this.getString( R.string.quizz_politique ));
