...
public class CulturalActivity extends AppCompatActivity {
    ...
    private Button textCounterDownCultural;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CulturalToolbar = findViewById( R.id.Capital_Toolbar);
        ...
        mAdView = (AdView) findViewById(R.id.adViewCultural);
    ...
    private void ShowPopup() {
        ...
        mScoreView.setText( getString( R.string.score )+" "+ mScore+ "/" +culturalQuestions.getLength()+ " ");
    ...
    public void toggleSuondCultural(View view){

        Button toggleSuondArt = (Button) findViewById(R.id.toggleSuondCultural);
