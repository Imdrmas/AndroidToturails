...
public class GeneralActivity extends AppCompatActivity {
    ...
    private Button textCounterDownGeneral;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GeneralToolbar = findViewById( R.id.Generall_Toolbar);
        ...
        mAdView = (AdView) findViewById(R.id.adViewGeneral);
    ...
    private void ShowPopup(){
        ...
        mScoreView.setText( getString( R.string.score )+" "+ mScore+ "/" +generalQuestions.getLength()+ " ");
        ...
        if (heightScore == 100){
            ...
            btnFinishCancel.setText( getString( R.string.annuler ));
    ...
    public void toggleSuondGeneral(View view){

        Button toggleSuondArt = (Button) findViewById(R.id.toggleSuondGeneral);
    ...
    protected void onStart() {
        ...
        TextView titleTextDialog = (TextView) layout.findViewById( R.id.titleTextDialog );
        titleTextDialog.setText(this.getString( R.string.quizz_culturel ));
