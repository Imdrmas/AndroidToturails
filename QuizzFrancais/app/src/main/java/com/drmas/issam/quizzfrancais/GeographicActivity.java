...
public class GeographicActivity extends AppCompatActivity {
    ...
    private GégrapgieQuestions gégrapgieQuestions = new GégrapgieQuestions();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        geographicToolbar = findViewById( R.id.Geographic_Toolbar);
        ...
        mAdView = (AdView) findViewById(R.id.adViewGeographic);
    ...
    private void ShowPopup() {
        ...
        mScoreView.setText( getString( R.string.score )+" "+ mScore+ "/" +gégrapgieQuestions.getLength()+ " ");
    ...
    public void toggleSuondGeography(View view){

        Button toggleSuondArt = (Button) findViewById(R.id.toggleSuondGeographiy);
    ...
    private void updateQuestions(){
        ...
        if (mQuestionNumber<gégrapgieQuestions.getLength()){

            mQuestionViewGeographic.setText( gégrapgieQuestions.getQuestions( mQuestionNumber ));

            mButtonChoice1Geographic.setText( gégrapgieQuestions.getChoice( mQuestionNumber, 1));
            mButtonChoice2Geographic.setText( gégrapgieQuestions.getChoice( mQuestionNumber, 2));
            mButtonChoice3Geographic.setText( gégrapgieQuestions.getChoice( mQuestionNumber, 3));
            mButtonChoice4Geographic.setText( gégrapgieQuestions.getChoice( mQuestionNumber, 4));

            mAnswer = gégrapgieQuestions.getCorrectAnswer( mQuestionNumber );
            mQuestionNumber++;
    ...
    protected void onStart() {
        ...
        TextView titleTextDialog = (TextView) layout.findViewById( R.id.titleTextDialog );
        titleTextDialog.setText(this.getString( R.string.quizz_géographie ));
