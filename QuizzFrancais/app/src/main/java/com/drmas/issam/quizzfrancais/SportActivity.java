...
public class SportActivity extends AppCompatActivity {
    ...
    private Button textCounterDownSport;
    ...
    private TextView textCorrectCountSport, textWrongCountSport;
    private TextView countQuestionDownSport;
    /// ending of main page
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SportToolbar = findViewById( R.id.Sport_Toolbar);
    ...
    private void ShowPopup() {
        ...
        mScoreView.setText( getString( R.string.score )+" "+ mScore+ "/" +sportQuestions.getLength()+ " ");
    ...
    protected void onStart() {
        ...
        TextView titleTextDialog = (TextView) layout.findViewById( R.id.titleTextDialog );
        titleTextDialog.setText(this.getString( R.string.quizz_sport ));
