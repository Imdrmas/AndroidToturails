...
import static com.drmas.issam.quizzfrancais.R.string.quizz_télévision;

public class TelevisionActivity extends AppCompatActivity {

    private Toolbar TelevisionToolbar;
    private Button textCounterDownTelevision;

    private TelevisionQuestions televisionQuestions = new TelevisionQuestions();

    private TextView mQuestionViewTelevision;
    private Button mButtonChoice1Television, mButtonChoice2Television;
    private Button mButtonChoice3Television, mButtonChoice4Television;

    private TextView textCorrectCountTelevision, textWrongCountTelevision;
    private TextView countQuestionDownTelevision;
    /// ending of main page
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TelevisionToolbar = findViewById( R.id.Television_Toolbar);
        setSupportActionBar( TelevisionToolbar );
        setTitle( null );

        myDialog = new Dialog( this );

        textCorrectCountTelevision = (TextView) findViewById( R.id.textCorrectCountTelevision);
        textWrongCountTelevision = (TextView) findViewById( R.id.textWrongCountTelevision );
        countQuestionDownTelevision = (TextView) findViewById( R.id.countQuestionDownTelevision);

        textCounterDownTelevision = (Button) findViewById( R.id.counterDownTelevision );
        countDownTimer = new CountDownTimer(16000, 1000) {
            @Override
            public void onTick(long millisUntilFinished) {
                textCounterDownTelevision.setText(""+ millisUntilFinished/1000 );
            }

            @Override
            public void onFinish() {
                textCounterDownTelevision.setText( "done" );
        ...
        mQuestionViewTelevision = (TextView) findViewById( R.id.textQuestionTelevision );

        mButtonChoice1Television = (Button) findViewById( R.id.ButtonChoice1Television );
        mButtonChoice2Television = (Button) findViewById( R.id.ButtonChoice2Television );
        mButtonChoice3Television = (Button) findViewById( R.id.ButtonChoice3Television );
        mButtonChoice4Television = (Button) findViewById( R.id.ButtonChoice4Television );

        updateQuestions();

        mAdView = (AdView) findViewById(R.id.adViewTelevision);
    ...
    private void ShowPopup() {
        ...
        mScoreView.setText( getString( R.string.score )+" "+ mScore+ "/" +televisionQuestions.getLength()+ " ");
        ...
        btnCancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent( TelevisionActivity.this, HeightScore.class );
                intent.putExtra( "scoreTelevision", mScore );
            ...
            if (heightScore == 0){
                ...
                btnCancel.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent( TelevisionActivity.this, HeightScore.class );
                        intent.putExtra( "scoreTelevision", heightScore );
                        startActivity( intent );
        ...
        if (heightScore == 100){
            ...
            btnFinishScore.setOnClickListener( new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent( TelevisionActivity.this, HeightScore.class );
                    intent.putExtra( "scoreTelevision", 100 );
                    startActivity( intent );
                }
            });
    ...
    public void correctCount(){
        ...
        correctCountCounter++;
        textCorrectCountTelevision.setText(String.valueOf( correctCountCounter ));
    ...
    public void wrongCount(){
        ...
        wrongCountCounter++;
        textWrongCountTelevision.setText(String.valueOf( wrongCountCounter ));

    }

    public void countQuestionDown(){
        questionsDown--;
        countQuestionDownTelevision.setText( String.valueOf( questionsDown ));
    }

    public void toggleSuondTelevision(View view){

        Button toggleSuondArt = (Button) findViewById(R.id.toggleSuondTelevision);
    ...
    private void updateQuestions(){
        ...
        if (mQuestionNumber<televisionQuestions.getLength()){

            mQuestionViewTelevision.setText( televisionQuestions.getQuestions( mQuestionNumber ));

            mButtonChoice1Television.setText( televisionQuestions.getChoice( mQuestionNumber, 1));
            mButtonChoice2Television.setText( televisionQuestions.getChoice( mQuestionNumber, 2));
            mButtonChoice3Television.setText( televisionQuestions.getChoice( mQuestionNumber, 3));
            mButtonChoice4Television.setText( televisionQuestions.getChoice( mQuestionNumber, 4));

            mAnswer = televisionQuestions.getCorrectAnswer( mQuestionNumber );
            mQuestionNumber++;
    ...
    public void onClickBtnTelevision(View view){
    ...
    public void mainActivity(){
        Intent intentMain = new Intent(TelevisionActivity.this, MainActivity.class);
    ...
    protected void onStart() {
        ...
        TextView titleTextDialog = (TextView) layout.findViewById( R.id.titleTextDialog );
        titleTextDialog.setText( this.getString( R.string.quizz_télévision ));
    ...
    private void showAnswer() {
        ...
        webView.loadUrl("file:///android_asset/"+television+".html");
