...
public class CapitalActivity extends AppCompatActivity {
    ...
    private CapitalsQuestions capitalsQuestions = new CapitalsQuestions();
    ...
    private TextView countQuestionDownCapital;
    /// ending of main page
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CapitalToolbar = findViewById( R.id.Capital_Toolbar);
        ...
        mAdView = (AdView) findViewById(R.id.adViewCapital);
    ...
    private void ShowPopup() {
        ...
        mScoreView.setText( getString( R.string.score )+" "+ mScore+ "/" +capitalsQuestions.getLength()+ " ");
    ...
    public void toggleSuondCapital(View view){

        Button toggleSuondArt = (Button) findViewById(R.id.toggleSuondCapital);
    ...
    private void updateQuestions(){
        ...
        if (mQuestionNumber<capitalsQuestions.getLength()){

            mQuestionViewCapital.setText( capitalsQuestions.getQuestions( mQuestionNumber ));

            mButtonChoice1Capital.setText( capitalsQuestions.getChoice( mQuestionNumber, 1));
            mButtonChoice2Capital.setText( capitalsQuestions.getChoice( mQuestionNumber, 2));
            mButtonChoice3Capital.setText( capitalsQuestions.getChoice( mQuestionNumber, 3));
            mButtonChoice4Capital.setText( capitalsQuestions.getChoice( mQuestionNumber, 4));

            mAnswer = capitalsQuestions.getCorrectAnswer( mQuestionNumber );
            mQuestionNumber++;
    ...
    protected void onStart() {
        ...
        TextView titleTextDialog = (TextView) layout.findViewById( R.id.titleTextDialog );
        titleTextDialog.setText(this.getString( R.string.quizz_capitaux ));
