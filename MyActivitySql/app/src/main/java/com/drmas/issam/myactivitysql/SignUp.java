...
public class SignUp extends AppCompatActivity {
    ...
    public void SQLiteTableBuild() {
        ...
        sqLiteDatabaseObj.execSQL("CREATE TABLE IF NOT EXISTS "
                + SQLiteHelper.TABLE_NAME + "(" + SQLiteHelper.Table_Column_ID
                + " PRIMARY KEY AUTOINCREMENT NOT NULL, "
                + SQLiteHelper.Table_Column_1_Name
                + " VARCHAR, " + SQLiteHelper.Table_Column_2_Email
    ...
    public void InsertDataIntoSQLiteDatabase(){
        ...
        if(EditTextEmptyHolder == true)
        {
            ...
            SQLiteDataBaseQueryHolder = "INSERT INTO "
                    +SQLiteHelper.TABLE_NAME+" (name,email,password) VALUES('"
                    +NameHolder+"', '"+EmailHolder+"', '"+PasswordHolder+"');";
        ...
        // This block will execute if any of the registration EditText is empty.
            ...
            Toast.makeText(SignUp.this,"Please Fill All The Required Fields.",
                    Toast.LENGTH_LONG).show();
