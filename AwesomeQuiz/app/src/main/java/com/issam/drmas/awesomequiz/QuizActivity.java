package com.issam.drmas.awesomequiz;
...
public class QuizActivity extends AppCompatActivity {
    ...
    private TextView textViewCountDwon;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewCountDwon = findViewById(R.id.text_view_countdown);
        ...
        textColorDefaultCd = textViewCountDwon.getTextColors();
    ...
    private void updateCountDownText(){
        ...
        textViewCountDwon.setText(timeFormatted);


        if (timeLeftInMillis < 10000){
            textViewCountDwon.setTextColor(Color.RED);
        } else {
            textViewCountDwon.setTextColor(textColorDefaultCd);
        }
    }
